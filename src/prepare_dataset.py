...
# Class mappings: mapping raw dataset folders to target consolidated classes
CLASS_MAPPINGS = {
    'hazardous': [
        'batteries',
        'e-waste',
    ...
    for target_class, source_folders in CLASS_MAPPINGS.items():
        ...
        for folder in source_folders:
            ...
            if not os.path.exists(folder_path):
                # Try replacing slashes in case of OS differences
        ...
        for split_name, img_list in splits.items():
            ...
            for idx, img_path in enumerate(img_list):
                # Maintain original extension but rename to avoid naming collisions
